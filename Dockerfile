...
ARG TARGETARCH
ARG BUILDPLATFORM
WORKDIR /go/src/github.com/jranabahu/process-exporter
ADD . .
...
COPY --from=build /go/src/github.com/jranabahu/process-exporter/process-exporter /bin/process-exporter
